...
- **Tool catalog** — exact signatures, parameter names, types, defaults, and descriptions for all 212 tools across Drive, Gmail, Calendar, Sheets, Slides, Docs, Tasks, and Forms.
