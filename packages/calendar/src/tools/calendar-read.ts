...
import { calendarGetCalendarSchema, calendarGetEventSchema } from '@workspace-lite/shared/schemas'
import { callProxy } from '../proxy.js'

export function registerCalendarReadTools(server: ToolServer) {
  ...
  server.tool('calendar_get_calendar', 'Get details of a specific calendar.', calendarGetCalendarSchema,
