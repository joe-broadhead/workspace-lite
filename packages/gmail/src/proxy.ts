...
const PROXY_URL = process.env.GOOGLE_WORKSPACE_GMAIL_PROXY_URL ?? ''
const PROXY_TOKEN = process.env.GOOGLE_WORKSPACE_GMAIL_PROXY_TOKEN ?? ''

if (!PROXY_URL) throw new Error('GOOGLE_WORKSPACE_GMAIL_PROXY_URL not set')
if (!PROXY_TOKEN) throw new Error('GOOGLE_WORKSPACE_GMAIL_PROXY_TOKEN not set')
